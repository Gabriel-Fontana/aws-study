# ☁️ AWS Cloud Mastery - Gabriel Fontana
...
| :--- | :--- | :--- |
| **[01 - Fundamentos](./modulo-01-fundamentos)** | CapEx vs OpEx, Nuvem Pública/Privada | Teoria Estratégica |
| **[02 - Compute (EC2)](./modulo-02-compute)** | Servidores Virtuais, Auto Scaling e ELB | [Script de Automação (Bash)](./modulo-02-compute/instalar-nginx.sh) |
| **[03 - Serverless](./modulo-03-compute-services)** | AWS Lambda, Docker e Containers | [Função Lambda (Python)](./modulo-03-compute-services/hello-lambda.py) |
| **[04/05 - Networking](./modulo-04-05-network)** | VPC, Subnets e Route 53 | [Regras de Firewall](./modulo-04-05-network/firewall-rules.txt) |
